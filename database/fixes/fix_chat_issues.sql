-- FIX CHAT ISSUES: RLS & Constraints
-- 1. Ensure Profiles are Searchable (Public Read)
-- 2. Prevent Duplicate Conversations
-- 3. Fix Message RLS

-- 1. PROFILES: Allow authenticated users to view basic info of others (for search)
...
-- 2. CONVERSATIONS: Ensure RLS allows users to see their own conversations (both as buyer and seller)
...
-- 5. FUNCTION to safely get or create conversation (Server side logic to prevent race conditions)
