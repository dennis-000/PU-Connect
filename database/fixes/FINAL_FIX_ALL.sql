-- FINAL FIX: Database Health & Features
-- 1. Fixes User Deletion Bug (Missing Columns)
-- 2. Initializes SMS Templates for Admin Customization
-- 3. Ensures Platform Settings Table Exists

-- A. ENSURE CONFIG TABLE EXISTS
...
-- C. ENABLE SMS CUSTOMIZATION (TEMPLATES)
-- Initializes the templates so they appear in the Admin Dashboard
-- Removes quotes from JSONB strings for cleaner editing if previously double-encoded
