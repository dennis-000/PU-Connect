...
function Marketplace() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-300 font-sans">
      ...
      <section className="relative pt-32 pb-12 md:pt-40 md:pb-16 overflow-hidden bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 dark:bg-gray-950">
        <div className="absolute inset-0 bg-gradient-to-br from-white/40 via-white/20 to-white/40 dark:from-gray-950/90 dark:to-gray-950"></div>

        <div className="max-w-7xl mx-auto px-6 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white dark:bg-gray-800 border border-orange-200 dark:border-gray-700 rounded-full mb-6 shadow-sm">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-orange-500 via-amber-500 to-yellow-500">Marketplace</span>
          </h1>
          ...
          <div className="max-w-2xl mx-auto relative">
            ...
            >
              ...
              <button
                type="submit"
                className="px-6 md:px-8 h-12 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-bold rounded-xl transition-all shadow-lg active:scale-95 text-sm"
              >
                Search
              </button>
            </form>
      ...
      <div className="sticky top-20 z-40 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-b border-orange-100 dark:border-gray-800">
            ...
            {categories.map((category) => (
              <button
                ...
                className={`flex items-center gap-2 px-4 py-2.5 rounded-full transition-all duration-300 border text-sm font-bold whitespace-nowrap ${selectedCategory === category.id
                  ...
                  : 'bg-transparent text-gray-600 dark:text-gray-400 border-gray-200 dark:border-gray-700 hover:bg-orange-50 dark:hover:bg-gray-800 hover:border-orange-200 dark:hover:border-gray-600'
                  }`}
              >
      ...
      <div className="max-w-[1720px] mx-auto px-4 sm:px-6 lg:px-8 relative z-20">
        <div className="py-8 md:py-12">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-6">
            <div>
              <p className="text-orange-600 dark:text-orange-400 font-bold text-xs mb-2">
            ...
            <div className="w-full md:w-auto">
              <div className="relative group z-30 w-full md:w-48">
                <select
                  ...
                  className="appearance-none w-full bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 py-3 pl-4 pr-10 rounded-xl font-medium text-sm focus:ring-2 focus:ring-orange-500 cursor-pointer shadow-sm hover:shadow-md transition-shadow text-gray-700 dark:text-gray-200"
                >
          ...
          {productsLoading ? (
              ...
              {filteredAndSortedProducts.map((product) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative aspect-[4/5] rounded-[2rem] overflow-hidden bg-gray-100 dark:bg-gray-800 mb-4 shadow-sm group-hover:shadow-xl transition-all duration-500 group-hover:-translate-y-2">
                      {product.images?.[0] ? (
                        <img
                      ...
                      <div className="absolute bottom-3 left-3 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md px-4 py-2 rounded-full shadow-lg">
                    ...
                    {/* Minimal Content */}
                    <div className="px-2">
                      <h3 className="text-base font-bold text-gray-900 dark:text-white mb-1 line-clamp-1 group-hover:text-orange-600 transition-colors">
                        {product.name}
                      </h3>
            ...
            <div className="py-32 text-center bg-white dark:bg-gray-900 rounded-[3rem] border border-gray-100 dark:border-gray-800">
              ...
              <button
                ...
                className="px-8 py-3 bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-600 hover:to-amber-600 text-white font-bold rounded-xl shadow-lg transition-all text-sm"
              >
                Reset Search
              </button>
            </div>
