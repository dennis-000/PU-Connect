  ...
  const signUp = async (
    ...
    try {
      ...
      import('../lib/arkesel').then(({ sendSMS }) => {
        sendSMS([phone], `Welcome to Campus Konnect, ${fullName}! Your account has been successfully created. Browse the marketplace and connect with fellow students.`, 'welcome')
